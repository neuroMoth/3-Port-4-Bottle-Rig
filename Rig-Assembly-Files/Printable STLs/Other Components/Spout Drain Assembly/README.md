## Spout Drain Assembly Components

This directory contains the files for the Spout Drain Assembly used when draining and calibrating valves inside the 
teflon tube spout. 

To print all the components you will need for one Drain Assembly:
