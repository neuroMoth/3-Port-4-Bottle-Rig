## Delivery Frame Components

To print all the components you will need for one barrier strip cover:

- open the .3mf file named 'Barrier Strip Case - Both components for ONE' in PrusaSlicer.
