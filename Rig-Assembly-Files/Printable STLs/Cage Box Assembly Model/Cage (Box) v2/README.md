...
This directory contains the parts used for the animal box. This includes 4 cage legs, lid corners, and the latches which lock the lid in place. 

* open the .3mf file in PrusaSlicer.
...
All STL files are the individual parts that are included in the 3mf file. STL files can be loaded into software (e.g. Autodesk Fusion or SolidWorks) for modifying 3d models if a part needs to be edited. Individual STL models can be opened in PrusaSlicer but the print settings won't be included. 
