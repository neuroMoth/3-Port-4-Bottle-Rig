## Spout Door (Linear Actuator) Components v2

Current as of 7/28/26 (TVD). This version has different center and lateral door mounts. Both now use the small rails to make movement more precise, but the center door also has connections for the spout waste vacuum during rinse. 



This directory contains all the printable stl files for the port doors used in the 3 port rig. This included the mount from the linear actuator to the breadboard, as well as the top bracket connecting the actuator to the aluminum door.

To print Linear Actuator components:

* open the .3mf file for the part you need in PrusaSlicer.
