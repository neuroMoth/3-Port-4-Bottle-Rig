...
function sessionSummary(animal, date)
    ...
    fprintf('The session was roughly %d minutes and %d seconds long.\n', sessionMinutes, sessionSeconds);
    fprintf('# Engaged Trials: %d/%d. # Not engaged: %d/%d.\n', ...
        nEngagedTr,nTotalTr,nTotalTr-nEngagedTr,nTotalTr);
    fprintf('# Correct Trials: %d/%d.\n',nCorrectTr,nTotalTr);
    %fprintf('# Incorrect Trials: %d/%d\n',,nTotalTr); 
end 