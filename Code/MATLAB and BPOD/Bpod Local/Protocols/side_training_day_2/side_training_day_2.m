...
% SIDE TRANING DAY 2
% ODOR ONLY IS DELIVERED IN THE CENTER PORT ONLY. ODOR IS DELIVERED ON THE LEFT PORT ONLY.



function side_training_day_1
    global BpodSystem
% configure the flexIO to all be OUPUTS, so that the state machine can
% command the arduino that drives motor movements.
...
LoadSerialMessages('ValveModule1', {['O' CENTER_VALVE], ['C' CENTER_VALVE], ['O' PORT_1_VALVE], ['C' PORT_1_VALVE]});  % load valve for center port into serial messages.
...
%   - tup -> no rat interaction, move to new ITI
...
sma = AddState(sma, 'Name', 'TTC_Center', ...
    'Timer', 30,...
    'StateChangeConditions', {'Tup', 'ITI','AnalogIn1_1', 'firstCenterLick', 'GlobalTimer1_End', 'cleanup'},...
...
sma = AddState(sma, 'Name', 'oddLick', ...
    'Timer', 0,...
    'StateChangeConditions', {'AnalogIn1_1', 'waterRewardLick', 'GlobalTimer1_End', 'cleanup', 'GlobalTimer2_End', 'ITI'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 1,'Flex3DO', 0, 'Flex4DO', 0});
...
sma = AddState(sma, 'Name', 'waitForNonFirstOdd', ...
    'Timer', 0,...
    'StateChangeConditions', {'AnalogIn1_1', 'oddLick', 'GlobalTimer1_End', 'cleanup', 'GlobalTimer2_End', 'ITI'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 1,'Flex3DO', 0, 'Flex4DO', 0, 'GlobalTimerTrig', 2});
...
sma = AddState(sma, 'Name', 'waterRewardLick', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup', 'beginCenterValve', 'GlobalTimer1_End', 'cleanup', 'GlobalCounter1_End', 'TTC_Port_1'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 1,'Flex3DO', 0, 'Flex4DO', 0});
...
sma = AddState(sma, 'Name', 'TTC_Port_1', ...
    ...
    'OutputActions',{'Flex1DO', 1, 'Flex2DO', 0,'Flex3DO', 0, 'Flex4DO', 0, 'GlobalCounterReset', 1});


sma = AddState(sma, 'Name', 'cleanup', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup', 'exit'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 0,'Flex3DO', 0, 'Flex4DO', 0, 'ValveModule1', 2, 'BNC1', 0, 'SoftCode', 3});
