...
%% RANDOM TRAINING 2 PROTOCOL V2 | 2 OPERANT RESPONSE TASK
% SERVES AS RETRAINING PROTOCOL DURING THE TESTING PERIOD. IDENTICAL TO TESTING PROTOCOL V2. 
function randomTraining2_v2
    ...
    for trial = 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'ttcLateral', ...
            ...
            'StateChangeConditions', {'Tup', 'reportSkip', correct_port.lick_input, 'waitLateralDryLicks', incorrect_port.lick_input,...
        ...
        %%%%% SESSION END %%%%% -> Doesn't actually work
