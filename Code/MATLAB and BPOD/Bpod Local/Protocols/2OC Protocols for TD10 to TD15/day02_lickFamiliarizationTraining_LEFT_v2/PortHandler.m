classdef PortHandler
    ...
    methods
        ...
        function obj = setPort(obj, port_num, port_inst)
            % general function which can take a lateral or center port and assign it to a handler
            obj = obj.setProperties(port_num, port_inst); 
        end
    end
        ...
        function obj = setProperties(obj, port_number, port_instance)
            global BpodSystem
                ...
                elseif port_number == 2 % center port
                    ...
                    obj.valve = port_instance.left_valve; 
                end
