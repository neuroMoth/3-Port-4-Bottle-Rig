...
%% LICK FAMILIARIAZATION | DAY 2: LEFT | WATER ONLY AT ONE OF THE 3 PORTS
% Unlimited access at one of the 3 ports. Valve opens for the 1st lick, then opens on every 5th lick.
function day02_lickFamiliarizationTraining_LEFT_v2
    ...
    fprintf('Port%d. Valve%d. %d dry licks. %dms valve delay. \n', portSession, thisValve, num_dryLicks, center_valveDelay*1000);
    fprintf('\nCount Number of Reward Licks: \n')
    ...
    sma = AddState(sma, 'Name', 'start', ...
        'Timer', 3,...
        'StateChangeConditions', {'Tup', 'primeValve', expV.experimentTimeExpired, 'cleanup'},...
        'OutputActions',{thisPort.door, expV.UP});
    sma = AddState(sma, 'Name', 'primeValve', ...
        'Timer', thisPort.valve_time, ...
        'StateChangeConditions', {'Tup','primeValveStop'}, ...
        'OutputActions',{thisPort.door, expV.UP, 'ValveModule1', ['O' thisPort.valve]});
    sma = AddState(sma, 'Name', 'primeValveStop', ...
        'Timer', 0,...
        'StateChangeConditions', {'Tup', 'waitForFirstLick'},...
        'OutputActions',{thisPort.door, expV.UP, 'ValveModule1', ['C' thisPort.valve]});
    ...
    sma = AddState(sma, 'Name', 'firstRewardLick', ...
        ...
        'GlobalCounterReset', thisPort.lick_counter_id, 'SoftCode', 4});
    ...
    sma = AddState(sma, 'Name', 'waitDryLicks', ...
        'Timer', 5,...
        'StateChangeConditions', {'Tup', 'waitRewardLick', thisPort.lick_counter_event, 'waitRewardLick', ...
    ...
    fprintf('%d total licks.', BpodSystem.Data.lickNumber)
    fprintf('\n')
