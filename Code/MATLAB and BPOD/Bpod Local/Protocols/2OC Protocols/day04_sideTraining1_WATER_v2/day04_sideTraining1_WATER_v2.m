...
function day04_sideTraining1_WATER_v2
    ...
    for trial = 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'ttcLateral', ...
            ...
            'StateChangeConditions', {'Tup', 'reportSkip', correct_port.lick_input, 'waitLateralRewardLick', incorrect_port.lick_input,...
            'waitLateralDryLicks' expV.experimentTimeExpired , 'cleanup', expV.lickTimeExpired, 'reportSkip'},...
