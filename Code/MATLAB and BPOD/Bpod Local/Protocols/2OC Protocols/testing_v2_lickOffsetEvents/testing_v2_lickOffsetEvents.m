...
function testing_v2_lickOffsetEvents
    ...
    for trial = 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'TTC_Center', ...
            ...
            'OutputActions',{center_port.DOOR, 'GlobalCounterReset', center_port.LEFT_COUNTER_ID, ...
            expV.DOWN, 'AnalogIn1', ['#' 0], 'WavePlayer1', ['P' 8 0]});
