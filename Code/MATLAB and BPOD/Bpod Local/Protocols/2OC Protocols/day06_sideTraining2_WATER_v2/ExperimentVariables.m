classdef ExperimentVariables 
    properties (Constant)
        ...
        STIMULUS_WINDOW = 400/1000; %ms after valve closes before door goes up (if still within LICK_WINDOW)

        VALVE_SET1 = [2, 3, 4]; %Water valves
        VALVE_SET2 = [5, 6, 7]; %Odor valves
        
        REWARD_LICKS = [2]; %range of possible rewarded licks at the center (+1 from # of dry licks)
