...
% WATER CENTER | ODOR RIGHT
% WATER IS DELIVERED IN THE CENTER PORT ONLY. ODOR IS DELIVERED ON THE RIGHT PORT ONLY.
...
LoadSerialMessages('ValveModule1', {['O' CENTER_VALVE], ['C' CENTER_VALVE], ['O' PORT_3_VALVE], ['C' PORT_3_VALVE],['B' 00000000]});  % load valve for center port into serial messages.
