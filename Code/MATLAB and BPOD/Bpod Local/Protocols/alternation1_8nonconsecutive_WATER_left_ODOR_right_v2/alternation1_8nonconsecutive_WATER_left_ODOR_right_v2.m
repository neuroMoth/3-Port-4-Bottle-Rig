...
%% ALTERNATION 8 NONCONSECUTIVE TRAINING PROTOCOL V2 | WATER LEFT (Port 1)| ODOR RIGHT (Port 3)
function alternation1_8nonconsecutive_WATER_left_ODOR_right_v2
    ...
    for trial = 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'waitFinalIncorrectLick', ...
            'Timer', 0,...
            'StateChangeConditions', {incorrect_port.lick_counter_event, 'reportIncorrect', ...
