classdef ExperimentVariables 
    properties (Constant)
        ...
        GAS_TIME = 0.3; % time for gas purge
        ...
        STIM_VOLUME = 5; 
        PRIMING_VOLUME = 100; % 0.5x dead space of the manifold (current estimate about 100ul). For "seasoning" step. 
        LOAD_VOLUME = 150; % 2.5x dead space of the manifold. Fills the manifold and pushes the first amount to waste. 
        RINSE_VOLUME = 600; % 500ul (0.5ml) for each rinse round (2 rounds with gas clearing in between). 
