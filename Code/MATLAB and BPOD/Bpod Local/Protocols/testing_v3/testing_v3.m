    ...
    for trial = 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'ITI_stimPriming', ...
         ...
         sma = AddState(sma, 'Name', 'ITI_stimPrimingDelay', ...
            ...
            'OutputActions',{center_port.DOOR, expV.UP, expV.GAS_VALVE, 0, 'ValveModule1', ['C' center_port.left_valve]});
        ...
        sma = AddState(sma, 'Name', 'ITI_punish', ...
            ...
            'StateChangeConditions', {'Tup', 'resetCorrectCounter'},...
            'OutputActions',{port_1.DOOR, expV.UP, port_3.DOOR, expV.UP, 'ValveModule1', ['B' 0], expV.GAS_VALVE, 0});
