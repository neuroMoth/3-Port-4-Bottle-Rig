...
function testing_v3
    ...
    fprintf(['\nRinse: ' num2str(expV.RINSE_VOLUME), 'ul, ', num2str(valveRinseTime), 's per pulse (x2 pulses).'])
    fprintf(['\nGas: ' num2str(expV.GAS_TIME), 's per gas pulse.'])
    fprintf('\n')
    ...
    for trial = 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'ITI_stimPriming', ...
            ...
            'OutputActions',{center_port.DOOR, expV.UP, expV.GAS_VALVE, 0, 'ValveModule1', ['O' center_port.left_valve]});
        sma = AddState(sma, 'Name', 'ITI_gasClear4', ...
            'Timer', expV.GAS_TIME,...
            'StateChangeConditions', {'Tup', 'ITI_stimLoad'},...
            'OutputActions',{center_port.DOOR, expV.UP, expV.GAS_VALVE, 1, 'ValveModule1', ['C' center_port.left_valve]}); 
        ...
        sma = AddState(sma, 'Name', 'ITI_waitForRemaining', ...
            ...
            'OutputActions',{center_port.DOOR, expV.UP, 'ValveModule1', ['C' center_port.left_valve], ...
            'GlobalCounterReset', center_port.LEFT_COUNTER_ID});
        ...
        sma = AddState(sma, 'Name', 'resetCenterCounter', ...
            'Timer', 0,...
            'StateChangeConditions', {'Tup', 'cleanup'},...
