...
function lick_training_familiarization_CENTER 
    ...
    for trial= 1:expV.MAXIMUM_TRIALS
        ...
        center_port = center_port.setValve(1, center_port.WATER_VALVE);
        ...
        sma = AddState(sma, 'Name', 'centerPortDown', ...
            'Timer', 0,...
            'StateChangeConditions', {center_port.LEFT_LICK_INPUT, 'noRewardLick', 'GlobalTimer1_End', 'cleanup'},...
            'OutputActions',{center_port.DOOR, expV.DOWN});

        sma = AddState(sma, 'Name', 'noRewardLick', ...
            'Timer', 0,...
            'StateChangeConditions', {center_port.LEFT_LICK_INPUT, 'RewardLick', 'GlobalTimer1_End', 'cleanup'},...
            'OutputActions',{center_port.DOOR, expV.DOWN});
