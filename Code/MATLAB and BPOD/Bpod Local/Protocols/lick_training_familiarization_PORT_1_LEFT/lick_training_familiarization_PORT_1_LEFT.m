...
LoadSerialMessages('ValveModule1', {['O' PORT_1_VALVE], ['C' PORT_1_VALVE]});  % load valve for port 1 (LEFT) into serial messages.
...
sma = AddState(sma, 'Name', 'centerPortDown', ...
    'Timer', 0,...
    'StateChangeConditions', {'AnalogIn1_3', 'noRewardLick', 'GlobalTimer1_End', 'cleanup'},...
    'OutputActions',{'Flex1DO', 1, 'Flex2DO', 0,'Flex3DO', 0, 'Flex4DO', 0});

sma = AddState(sma, 'Name', 'noRewardLick', ...
    'Timer', 0,...
    'StateChangeConditions', {'AnalogIn1_3', 'RewardLick', 'GlobalTimer1_End', 'cleanup'},...
    'OutputActions',{'Flex1DO', 1, 'Flex2DO', 0,'Flex3DO', 0, 'Flex4DO', 0});
...
sma = AddState(sma, 'Name', 'flipValveOff', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup', 'centerPortDown', 'GlobalTimer1_End', 'cleanup'},...
    'OutputActions',{'Flex1DO', 1, 'Flex2DO', 0,'Flex3DO', 0, 'Flex4DO', 0, 'ValveModule1', 2, 'BNC1', 0});
