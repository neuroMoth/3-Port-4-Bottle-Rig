...
function side_training_day_1_odor_right
    ...
    for trial= 1:expV.MAXIMUM_TRIALS
        ...
        sma = AddState(sma, 'Name', 'waitForRemainingCenterDryLicks', ...
            'Timer', 0,...
            'StateChangeConditions', {center_port.LEFT_COUNTER_EVENT, 'waitCenterRewardLick1', expV.experimentTimeExpired , 'cleanup',...xpV.lickTimeExpired , 'punish'},...
            'OutputActions',{center_port.DOOR, expV.DOWN});

        sma = AddState(sma, 'Name', 'waitCenterRewardLick1', ...
            'Timer', 0,...
            'StateChangeConditions', {center_port.LEFT_LICK_INPUT, 'openCenterValve', expV.experimentTimeExpired , 'cleanup',...xpV.lickTimeExpired , 'punish' },...
            'OutputActions',{center_port.DOOR, expV.DOWN});
        ...
        sma = AddState(sma, 'Name', 'waitCenterRewardLick2', ...
            'Timer', 0,...
            'StateChangeConditions', {center_port.LEFT_LICK_INPUT, 'openCenterValve2', expV.experimentTimeExpired , 'cleanup',...xpV.lickTimeExpired , 'punish' },...
            'OutputActions',{center_port.DOOR, expV.DOWN});
        ...
        sma = AddState(sma, 'Name', 'waitSixthLick', ...
            'Timer', 0,...
            'StateChangeConditions', {center_port.LEFT_LICK_INPUT, 'ttcLateralTimeout', expV.experimentTimeExpired , 'cleanup',...xpV.lickTimeExpired , 'punish'},...
            'OutputActions',{center_port.DOOR, expV.DOWN});
