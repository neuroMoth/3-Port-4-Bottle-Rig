...
% SIDE TRANING DAY ONE 
% ODOR RIGHT | WATER CENTER 
% ODOR IS DELIVERED ON THE RIGHT PORT ONLY. WATER IS DELIVERED IN THE CENTER PORT ONLY.
...
sma = AddState(sma, 'Name', 'TTC_Port_1', ...
    'Timer', 60,...
    'StateChangeConditions', {'Tup', 'exit','AnalogIn1_3', 'firstLateralLick', 'GlobalTimer1_End', 'cleanup'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 0,'Flex3DO', 1, 'Flex4DO', 0, 'GlobalCounterReset', 3});
...
sma = AddState(sma, 'Name', 'oddLateralLick', ...
    'Timer', 0,...
    'StateChangeConditions', {'AnalogIn1_3', 'odorRewardLick', 'GlobalTimer1_End', 'cleanup', 'GlobalTimer2_End', 'exit'},...
...
sma = AddState(sma, 'Name', 'waitForNonFirstLateralOdd', ...
    'Timer', 0,...
    'StateChangeConditions', {'AnalogIn1_3', 'oddLateralLick', 'GlobalTimer1_End', 'cleanup', 'GlobalTimer2_End', 'exit'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 0,'Flex3DO', 1, 'Flex4DO', 0, 'GlobalTimerTrig', 2});
...
sma = AddState(sma, 'Name', 'odorRewardLick', ...
    'Timer', 0,...
    'StateChangeConditions', {'Tup', 'beginLateralValve', 'GlobalTimer1_End', 'cleanup', 'GlobalCounter3_End', 'rewardLick6_ITI'},...
    'OutputActions',{'Flex1DO', 0, 'Flex2DO', 0,'Flex3DO', 1, 'Flex4DO', 0});
