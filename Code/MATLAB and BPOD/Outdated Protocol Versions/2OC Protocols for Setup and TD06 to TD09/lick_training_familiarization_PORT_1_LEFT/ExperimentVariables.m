classdef ExperimentVariables 
    properties (Constant)
        TOTAL_ALLOWED_TIME = 1800; %seconds / 60 minutes.
        ITI_TIME = 0; %seconds 
        PUNISHMENT_TIME = 0; %seconds
        TTC_CENTER_TIME = 0; %seconds
        TTC_LATERAL_TIME = 0; %seconds
        LICK_WINDOW = 0; %seconds | Defines amount of seconds rat has to complete required amount of licks.
        LATERAL_DELAY = 0; %seconds 
