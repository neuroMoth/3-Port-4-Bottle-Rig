function [center_lineup, rewardLickOrder, rewardDelays, side_lineup] = GenerateCenterLineup()
...
if n_v1 == 1; maxV1Rep = inf; else; maxV1Rep = 10; end
if n_v2 == 1; maxV2Rep = inf; else; maxV2Rep = 10; end
...
for j = 1:num_blocks
    ...
    while ~isValidV1
        ...
        % Safety break
        if attemptsV1 > 10000
            error('Could not find a valid v1 sequence after many attempts. Try loosening constraints.');
        end
    end
    ...
    while ~isValidV2
        ...
        % Safety break
        if attemptsV2 > 10000
            error('Could not find a valid v2 sequence after many attempts. Try loosening constraints.');
        end
    end
    ...
    bestRepeatCount = inf; maxIterations = 5000;
